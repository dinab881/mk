...
class Pagination
{
    ...
    {
        $back = null; //Back ref
        $forward = null; //Forward ref
        $startpage = null; // 	in the beginning ref
        $endpage = null; //in the end ref
        $page2left = null; //second page left
        $page1left = null; //first page left
        $page2right = null; //second page right
